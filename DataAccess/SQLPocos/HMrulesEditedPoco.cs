...
{
    public class HMrulesEditedPoco
    {
        ...
        public string ClinicalAssessmentUrl { get; set; }

        public HMrulesEditedDomain MapToDomainModel()
        {
            HMrulesEditedDomain domain = new HMrulesEditedDomain
            {
                ...
                ClinicalAssessmentUrl = ClinicalAssessmentUrl
            };

            return domain;
        }

        public HMrulesEditedPoco() { }

        public HMrulesEditedPoco(HMrulesEditedDomain domain)
        {
            ...
            IntegrationPartner = domain.IntegrationPartner;
            ClinicalAssessmentUrl = domain.ClinicalAssessmentUrl;
        }
    }
}
